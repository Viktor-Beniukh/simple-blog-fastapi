...
from user.schemas import Token, TokenRefresh, UserResponse
...
async def refresh_token(refresh_token: str = Form(...)):
    ...
    return TokenRefresh(access_token=access_token, token_type="bearer")


@router.get("/user/me/", response_model=UserResponse)
async def get_user_profile(current_user: models.User = Depends(crud.get_current_user)):
